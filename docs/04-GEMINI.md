...
- Mantener la memoria del "por qué" de las decisiones (que luego se baja a `docs/15-DECISIONS.md`).
...
Instrucciones listas en `_research/proyecto-gemini.md`. Contexto a cargarle: `docs/00-VISION.md`, `docs/01-ROADMAP.md`, `CLAUDE.md`.
