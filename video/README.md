# video/ — Clips de producto animados (Remotion)

Proyecto [Remotion](https://www.remotion.dev/) (video con React) para generar clips
verticales 1080×1920 de producto: ken-burns lento sobre tu foto real + marca, badge,
precio animado y CTA. Sirven para historias/reels de producto (no para los reels de
autoridad, que van a cámara).
