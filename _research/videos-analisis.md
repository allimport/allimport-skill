...
**⚠️ Nota mía:** Coincide EXACTO con lo que propuse en la auditoría: **apuntar el vault de Obsidian a la carpeta del repo (`docs/`), que Obsidian y Claude lean los MISMOS archivos, sin sync**. El video valida la idea. Clave: la bóveda tiene que ser la carpeta del repo, no un almacén separado. Esto es tu #7 y encaja con la Ola 3 del roadmap.
