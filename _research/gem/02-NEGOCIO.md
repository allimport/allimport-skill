...
Spec completa en `contenido/AGENTE-WHATSAPP.md` del repo; acá solo lo que Gemini necesita
...
- Stack técnico: n8n + WAHA + Claude API + planilla (ver `_research/n8n-whatsapp.md`). Sin
