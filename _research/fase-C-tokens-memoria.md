...
2. **`docs/`** (✅ ya hecho) → el conocimiento durable está escrito, no se re-explica.
...
**Del lado del repo: ✅ LISTO.** Ya existe `docs/` con `README`, `architecture.md` y decisiones. Obsidian se conecta apuntando la bóveda ahí.

**Tu parte (10 min, en tu PC):**
1. Descargar Obsidian (obsidian.md).
2. "Abrir una carpeta como bóveda" → elegir la carpeta `docs/` del repo clonado.
