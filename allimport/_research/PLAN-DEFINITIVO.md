# PLAN DEFINITIVO — All Import

**Rumbo:** crecer en redes (marca personal `@_agus_moreno_`), foco en contenido. Base: plan del Grupo 1% (PDF) + 22 pasos originales + 12 videos analizados.
...
- ✅ **Calendario semanal** `allimport/contenido/CALENDARIO-SEMANAL.md` (#3)
- ✅ **10 ganchos + guiones** `allimport/contenido/GANCHOS-Y-GUIONES.md` (#4)
- ✅ **Branding** `allimport/contenido/DESIGN.md` (base del #8; faltan los carruseles)
- ✅ **Template base de clientes** `allimport/proveedores/base-datos-clientes-template.csv` (base del #12; falta cargar)
...
- ✅ **Docs:** `allimport/docs/ESTADO-INICIAL.md`, `allimport/docs/TERCEROS-PENDIENTES.md`, `README`/`CLAUDE.md` actualizados

## PENDIENTE — EN ORDEN

### FASE 0 · Base de perfil (YA)
1. Perfil `@_agus_moreno_`: bio, foto, sacar link WhatsApp, dejar `@allimport.cba` — 📱 vos *(PDF)*
2. Definir bloque fijo diario (hábito, no negociable) — 📱 vos *(PDF)*

### FASE 1 · Motor de contenido (foco #1)
3. ✅ Calendario semanal de contenido — HECHO (`allimport/contenido/CALENDARIO-SEMANAL.md`)
4. ✅ 10 ganchos + guiones de reels — HECHO (`allimport/contenido/GANCHOS-Y-GUIONES.md`)
...
7. Editar fotos de producto para historias — 🤖 💻 → subís vos 📱 *(herramienta lista en `allimport/historias/`; falta correrla con tus fotos)*
8. Carruseles IG de marca (Claude Design + `DESIGN.md`) — 🤖 💻 → subís vos 📱 *(V9)* *(DESIGN.md ✅; faltan los carruseles)*
9. Clips de producto animados (Remotion) — 🤖 💻 *(paso 17 + V3)* *(proyecto listo en `allimport/video/`)*
...
12. Base de datos de clientes — 🤖 template ✅ (`allimport/proveedores/base-datos-clientes-template.csv`) → cargás vos *(PDF)*
...
### FASE 3 · Investigación y crecimiento
16. Investigación de viralidad + competencia — 🤖 marco → vos me pasás qué ves 📱
...
19. ✅ skills.sh / `find-skills` — HECHO (documentado en `allimport/docs/ESTADO-INICIAL.md`)
...
22. Obsidian apuntando a `allimport/docs/` — 🙋 💻 vos *(paso 07)*
23. Conectores (GitHub/Figma/Supabase/Vercel...) — 🤝 vos tokens → 🤖 *(paso 15)*
24. Verificar comandos Revolutia antes de usar (terceros) — 🤖 *(V5)*
25. Proyectos en Claude (marketing, etc.) — 🙋 vos *(paso 22)*
26. Plan 7 días para dominar Cowork — 🙋 vos *(paso 18)*
27. 7 prompts de productividad (guardados, baja prioridad) — 🙋 *(paso 09)*

### FASE 5 · Seguridad (recién cuando exista backend)
28. 5 cosas para no ser hackeado (RLS, CORS, env, rate-limit, sanitizar) — 🤝 *(paso 04)*
29. Proteger Claude (3 prompts de seguridad) — 🤝 *(paso 12)*

### FASE 6 · Web (ÚLTIMA prioridad)
30. Terminar la web — 🤖 💻 *(paso 01)*
31. Web cinemática GSAP/parallax — 🤖 💻 *(V1)*
32. Deploy en Vercel — 🤝 vos cuenta → 🤖 *(V2)*
...
- Nada de métricas inventadas. "Guardado" ≠ "hecho".
- Un cambio = una rama `claude/*` = build verde.
