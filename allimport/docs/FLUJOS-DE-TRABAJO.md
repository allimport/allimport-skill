...
- `allimport/contenido/CALENDARIO-SEMANAL.md`, `allimport/contenido/GANCHOS-Y-GUIONES.md`,
  `allimport/contenido/GUIONES-STORIES.md`, `allimport/contenido/HALLAZGOS-VIRALES.md`,
  `allimport/contenido/SISTEMA-VENTAS-MARCA-PERSONAL.md`
...
**Carpetas/archivos propios:**
- `allimport/historias/` — editor de fotos (`editar_fotos.py`, `editar_historia_pro.py`),
  `stock-fotos/`, `generadas/`
- `allimport/contenido/PROMPT-MAESTRO-STORIES.md`
- `allimport/docs/DISEÑO.md` — sistema de diseño y reglas visuales validadas
- `allimport/video/` — proyecto Remotion
...
que solo existen ahí — ver `allimport/docs/REMOTE-CONTROL.md`.
...
**Carpetas/archivos propios:**
- `allimport/contenido/AGENTE-WHATSAPP.md`, `allimport/contenido/VOZ-AGUS.md`, `allimport/contenido/EJEMPLOS-RESPUESTAS.md`
- `allimport/proveedores/base-datos-clientes-template.csv`, skill `allimport-crm`
- `allimport/_research/n8n-whatsapp.md` (stack técnico)
