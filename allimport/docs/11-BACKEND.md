...
Aplicar los prompts de `allimport/_research/prompts-utiles.md`: **RLS** en Supabase, **CORS** restringido, credenciales en **env vars**, **rate limiting**, **sanitizar inputs**. (Origen: videos #04/#12.)
