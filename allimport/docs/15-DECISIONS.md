...
## Alcance
Índice de ADRs. Cada decisión concreta vive en `allimport/docs/decisions/NNNN-titulo.md`.
...
| # | Decisión | Estado |
|---|---|---|
| 0001 | El repo git es la única fuente de verdad (Obsidian apunta a `allimport/docs/`, sin sync) | aceptado |
...
*(Las que tienen `#` propio están en `allimport/docs/decisions/`; el resto se pueden formalizar ahí cuando convenga.)*
