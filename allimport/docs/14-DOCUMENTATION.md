...
## Alcance
Todo `allimport/docs/` + `CLAUDE.md` + `allimport/_research/`.

## Dónde va cada cosa
| Tipo | Lugar |
|---|---|
| Reglas que el agente lee siempre | `CLAUDE.md` (corto, <200 líneas) |
| Arquitectura, áreas, decisiones | `allimport/docs/00..16` |
| Decisiones puntuales (ADR) | `allimport/docs/decisions/NNNN-*.md` |
| Conocimiento/investigación/prompts | `allimport/_research/` |
...
- CLAUDE.md apunta a `allimport/docs/`; `allimport/docs/README.md` es el índice.
