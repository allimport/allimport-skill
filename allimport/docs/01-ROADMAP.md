...
## Alcance
El plan de construcción del ECOSISTEMA. El detalle de las 22 tareas del dueño vive en `allimport/_research/PLAN-MAESTRO.md` (fuente viva). Este archivo es la vista de arquitectura.
...
Núcleo documental `allimport/docs/` (este trabajo) · Obsidian apuntando a `allimport/docs/` (pendiente, lado usuario) · Claude Code GitHub Action (pendiente).
