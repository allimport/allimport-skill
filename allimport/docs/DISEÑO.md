...
- [`skills/allimport-web-design/references/DESIGN.md`](../../skills/allimport-web-design/references/DESIGN.md)
  ...
  de componente.
- [`allimport/contenido/DESIGN.md`](../contenido/DESIGN.md) — el branding original (tono de voz,
  frases sí/no, tono argentino).
- [`allimport/historias/fonts/`](../historias/fonts) — las fuentes Montserrat Alternates
...
- Fondo con **degradado**, nunca un velo plano parejo. Dos variantes válidas según el
  layout:
  - Piezas Pillow (título arriba + CTA abajo, como `allimport/historias/`): oscuro arriba/abajo
...
- **Prompt maestro de stories** — [`allimport/contenido/PROMPT-MAESTRO-STORIES.md`](../contenido/PROMPT-MAESTRO-STORIES.md)
  ...
  [`allimport/historias/stock-fotos/`](../historias/stock-fotos). Guiones ya escritos en
  [`allimport/contenido/GUIONES-STORIES.md`](../contenido/GUIONES-STORIES.md).

## 5. Dónde están las piezas ya hechas
- [`allimport/historias/generadas/`](../historias/generadas) — las historias de restock ya editadas,
  documentadas una por una en su README.
- [`allimport/historias/editar_historia_pro.py`](../historias/editar_historia_pro.py) — script
