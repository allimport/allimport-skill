...
No editar el contenido de acá sin actualizar también `allimport/docs/DISEÑO.md` §4 si cambia algo
...
- Reglas de estilo validadas para stories (máx. 2 estilos de texto, 1 solo acento,
  degradado no velo plano): `allimport/docs/DISEÑO.md`
- Fotos reales de producto para `.bg-photo`: `allimport/historias/stock-fotos/` — usá las que
...
Las fotos de fondo van en `allimport/historias/stock-fotos/` (ver §0). Si no existen, avisar antes de usar una alternativa.
...
3. Asigná fondos alternando las fotos disponibles en `allimport/historias/stock-fotos/`.
